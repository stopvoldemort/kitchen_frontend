      ...
      <div className="create-kitchen-container">
        ...
        <Form onChange={this.handleInputChange} onSubmit={this.handleSubmit}>
          ...
          <Form.Group widths='equal'>
            ...
            <Form.Input required name="price_per_guest" label="Each additional guest" value={this.state.price_per_guest} icon='dollar' iconPosition='left' placeholder='Price per guest' type="number" step="5"/>
          </Form.Group>
